...
function handleSubmitCancel() {
  dialogData.value.updateDialogVisible = false;
  dialogData.value.insertDialogVisible = false;
  dialogData.value.detailsDialogVisible = false;
}
...
<template>
  <div class="flex flex-col">
          ...
          <el-table-column label="操作" align="center" width="200px">
            <template #default="scope">
              ...
              <el-button type="primary" link @click="scoreDetail(scope.row)"
                >得分详情</el-button
              >
              <!-- <el-button class="btn-link" link @click="showDetails(scope.row)"
                >评分细则</el-button
              > -->
            </template>
          </el-table-column>
    ...
    >
      ...
      <!-- <el-card style="margin: 20px 10px 0 10px;" shadow="hover">
          <template #header>
            <div class="card-header">
              <span>扣分项</span>
            </div>
          </template>
          <el-table :data="detailParams.tableName" size="small" style="max-height: 250px;" >
              <el-table-column type="index" label="序号" />
              <el-table-column prop="name" align="center" label="加分项" />      
    ...
    <el-dialog
      ...
      class="system-detail-dialog"
    >
      <DetailsData ref="childDialog1" :type="1"></DetailsData>
    </el-dialog>
  </div>
</template>
