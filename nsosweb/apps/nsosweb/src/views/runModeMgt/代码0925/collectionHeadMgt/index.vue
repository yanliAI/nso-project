...
async function deleteAccount(){
  // try {
  //   const res = await DeleteAccountofLocalApi(data)
...
async function updateHead() {
  try {
    const obj = {
      orgId: personData.serachForm.orgId,
      personId: [...selectedIds.value]
    }
    await updateHeadApi(obj)
      ...
      <el-col :span="6">
        <div class="bg-white" style="height: 100%; padding: 20px">
          ...
          <div style="height: 750px; width: 100%; max-width: 370px; padding: 5px; overflow: auto; border: 1px solid #e0e0e0">
            <el-tree :data="displayTreeData" :props="defaultProps" default-expand-all node-key="id" :check-strictly="false" :expand-on-click-node="true" ref="treeRef" @node-click="handleCheckChange">
