    ...
    <div class="main-dg">
      <div class="gbzjd">
        <el-anchor class="jknb" :offset="90" type="default" :container="containerRef" direction="vertical" @click="handleClick">
          <el-anchor-link href="#part1" title="漏洞信息"></el-anchor-link>
          <el-anchor-link href="#part2" title="漏洞审核"></el-anchor-link>
          <el-anchor-link href="#part3" title="漏洞处理"></el-anchor-link>
          <el-anchor-link href="#part4" title="漏洞复测"></el-anchor-link>
          <el-anchor-link href="#part5" title="确认归档"></el-anchor-link>
        </el-anchor>
      </div>
      <div class="ma-tabm">
        <div class="head-d">
          <div class="text-center font-bold text-lg mt-2">系统漏洞管理</div>
        ...
        <div ref="containerRef" class="btm-d">
          <el-collapse v-model="activeNames" >
            <el-collapse-item title="漏洞信息" :icon="CaretRight" name="1">
              <template #title>
                <div class="flex items-center primary">
                  <Expand class="w-3.5 h-3.5"></Expand>
                  <div class="ml-1 font-bold">漏洞信息</div>
                </div>
              </template>
              <div id="part1" class="part-b">
                <LoopholeInfo ref="loopholeInfo" :formData="data.loopholeData"></LoopholeInfo>
              </div>
            </el-collapse-item>
            <el-collapse-item title="漏洞审核" :icon="CaretRight" name="2">
              <template #title>
                <div class="flex items-center primary">
                  <Expand class="w-3.5 h-3.5"></Expand>
                  <div class="ml-1 font-bold">漏洞审核</div>
                </div>
              </template>
              <div id="part2" class="part-b">
                <LoopholeVerify :formData="data.loopholeData"></LoopholeVerify>
              </div>
            </el-collapse-item>
            <el-collapse-item title="漏洞处理" :icon="CaretRight" name="3">
              <template #title>
                <div class="flex items-center primary">
                  <Expand class="w-3.5 h-3.5"></Expand>
                  <div class="ml-1 font-bold">漏洞处理</div>
                </div>
              </template>
              <div id="part3" class="part-b">
                <LoopholeHandle :formData="data.loopholeData"></LoopholeHandle>
              </div>
            </el-collapse-item>
            <el-collapse-item title="漏洞复测" :icon="CaretRight" name="4">
              <template #title>
                <div class="flex items-center primary">
                  <Expand class="w-3.5 h-3.5"></Expand>
                  <div class="ml-1 font-bold">漏洞复测</div>
                </div>
              </template>
              <div id="part4" class="part-b">
                <LoopholeRetest :formData="data.loopholeData"></LoopholeRetest>
              </div>
            </el-collapse-item>
            <el-collapse-item title="确认归档" :icon="CaretRight" name="5">
              <template #title>
                <div class="flex items-center primary">
                  <Expand class="w-3.5 h-3.5"></Expand>
...
import LoopholeInfo from './loopholeInfo.vue'
import LoopholeVerify from './loopholeVerify.vue'
import LoopholeHandle from './loopholeHandle.vue'
import LoopholeRetest from './loopholeRetest.vue'
...
onMounted(async () => {
  data.loopholeData = await initLoophole({id: id.value, type: '2'})
  data.loopholeData.correcteTime = formatDate(data.loopholeData.correcteTime)
});
