<template>
  <el-container class="h-full bg-white">
      ...
      <el-form label-width="auto" :model="data.formData" :inline="true" label-position="right" class="demo-form-inline mt-1">
        <el-row>
          ...
          <el-col :span="14">
            ...
            <el-button type="primary" class="ml-4" :icon="Plus" @click="add">新建</el-button>
    ...
    <el-main style="height: calc(100% - 95px)">
      <el-table ref="scheduleListTable" :data="data.tableData" border size="small" @selection-change="handleSelectionChange" style="height: 100%" stripe :header-cell-style="{ backgroundColor: '#F2F3F5', color: '#666666', fontSize: '14px', height: '40px', textAlign: 'center' }">
        <el-table-column type="selection" align="center" width="40"/>
        <el-table-column type="index" label="#" align="center" width="40" />
        <!-- <el-table-column prop="commandFl2" label="类型" column-key="NSOS_CMD_FL" :formatter="formatDrop" align="center" width="90" /> -->
        <el-table-column prop="templateName" label="模板名称" header-align="center" align="left" width="190" />
        <el-table-column prop="cmdContent" label="主要内容" align="left" width="480" />
        <el-table-column prop="slDeptStr" label="接受单位" align="left" />
        <el-table-column prop="finishLimit" label="完成时限(小时)" align="center" width="120" />
