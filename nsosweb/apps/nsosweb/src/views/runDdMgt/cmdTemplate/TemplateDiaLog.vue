  ...
  <div style="width: 100%; height: 100%;">
    <div style="height: calc(100% - 1px)">
      <el-form label-width="auto" ref="formRef" :model="formData" :rules="formRules" :inline="true"
        ...
        <el-row >
          <!-- <el-col :span="12">
              <el-form-item label="类型:" prop="commandFl2" style="margin-bottom: 18px">
                <el-select v-model="formData.commandFl2" clearable>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="主要内容:" prop="cmdContent" style="margin-bottom: 18px">
              <el-input v-model="formData.cmdContent" type="textarea" :rows="5" maxlength="1500" show-word-limit clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label="接受单位:" prop="slDept">
              <el-select v-model="formData.slDept" multiple placeholder="选择单位" collapse-tags collapse-tags-tooltip
                :max-collapse-tags="3" remote reserve-keyword clearable filterable style="width: 100%">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="完成时限(小时):" prop="finishLimit">
              <el-input placeholder="请输入数字" @input="handleNumberInput" v-model="formData.finishLimit" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const formRules = reactive({
  ...
  templateName: [
    ...
    { max: 40, message: '内容长度最大不能超过40', trigger: 'blur' }
  ],
  cmdContent: [
    { required: true, message: '指令内容不能为空', trigger: 'blur' },
    { min: 1, max: 1500, message: '内容长度最大不能超过1500', trigger: 'blur' }
  ],
  finishLimit: [
