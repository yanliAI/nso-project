  ...
  <el-container class="h-full bg-white">
    ...
    <el-main style="height: calc(100% - 90px);">
      <el-table border size="small" style="height: 100%;" ref="alarmRuleTab" :data="alarmRuleData" @selection-change="handleSelectionChange" @cell-click="showUnitInput">
        <el-table-column type="index" fixed width="60" label="#" align="center" />
        ...
        <el-table-column prop="isValid" label="是否有效" width="180" align="center">
          <template #default="scope">
            <el-select v-if="tableRowEditId === scope.row.id && tableColEditId === scope.column.id"
        ...
        <el-table-column prop="updateTime" label="最后修改时间" :formatter="formatTimestamp"  width="190" align="center"></el-table-column>
      </el-table>
    </el-main>
...
const query = async () => {
  ...
  alarmRuleData.value = response.list ? response.list : [];
  queryObjectType();
};
