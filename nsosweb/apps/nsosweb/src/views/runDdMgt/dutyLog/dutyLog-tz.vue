  ...
  <el-container class="h-full bg-white">
    ...
    <el-main style="height: calc(100% - 140px)">
      ...
      stripe :header-cell-style="{ backgroundColor: '#F2F3F5', color: '#666666', fontSize: '14px', height: '40px', textAlign: 'center' }">
        ...
        <el-table-column prop="commandCode" label="通知编号" align="center" width="150" />
        <el-table-column prop="commandContent" label="通知内容" width="300" />
        <el-table-column prop="commandTime" label="发送时间" :formatter="tDateTimeFormat" align="center" width="200" />
        <el-table-column prop="flDept" label="发送单位" align="center" width="150" />
        <el-table-column prop="commander" label="发送人" align="center" width="120" />
        <el-table-column prop="slDept" label="接收单位"  align="center" width="150" />
