  ...
  <el-container class="h-full bg-white">
    ...
    <el-main style="height: calc(100% - 140px)">
      ...
      stripe :header-cell-style="{ backgroundColor: '#F2F3F5', color: '#666666', fontSize: '14px', height: '40px', textAlign: 'center' }">
        ...
        <el-table-column prop="guaranteeLevel" label="重保等级" align="center" width="120" />
        <el-table-column prop="guaranteeContent" label="报障活动" />
        <el-table-column prop="guaranteeStartTime" label="报障开始时间" :formatter="tDateTimeFormat" align="center" width="150" />
        <el-table-column prop="guaranteeEndTime" label="报障结束时间" :formatter="tDateTimeFormat" align="center" width="150" />
        <el-table-column prop="systemTotalNum" label="系统总数" align="center" width="120" />
      </el-table>
    </el-main>
  ...
  tableData: [
    {
      ...
      guaranteeLevel: 'II级保障',
      guaranteeContent: '报障活动',
      guaranteeStartTime: '2025-03-10 01:15:34.000',
      guaranteeEndTime: '2025-03-10 01:15:34.000',
      systemTotalNum: '10',
    },
    {
      id: '2',
