  ...
  <el-container class="h-full bg-white">
    <el-header height="50px">
      <el-form label-width="auto" :model="data.formData" :inline="true" label-position="right" class="demo-form-inline mt-2">
        <el-row>
          <el-col :span="6">
            <el-form-item label="组织角色名称:" prop="orgName">
    ...
    <el-main style="height: calc(100% - 95px)">
      ...
      >
        ...
        <el-table-column prop="orgRoleSort" label="排序号" align="center" width="80" />
        <el-table-column prop="orgName" label="组织角色名称" align="center" width="200" />
        <el-table-column prop="orgRemark" label="组织角色说明" align="left" width="400" />
        <el-table-column prop="manCode" label="关联人员角色" align="left" />
        <el-table-column prop="creatorName" label="创建人" align="center" width="120" />
        <el-table-column prop="createTime" label="创建时间" :formatter="tDateTimeFormat" align="center" width="180" />
        <el-table-column prop="updatorName" label="最后修改人" align="center" width="120" />
        <el-table-column prop="updateTime" label="最后修改时间" :formatter="tDateTimeFormat" align="center" width="180" />
    ...
    <Modal class="h-[550px] w-[800px]" title="组织角色信息" :footer="false" :closeOnClickModal="false" :draggable="true">
      <dutyorg-detail :id="data.currentId" @closeDiaLog="closeDiaLog" @query="query" />
    </Modal>
  </el-container>
</template>
<script setup>
...
import { queryByPage } from './dutyorgMethod.ts'
import { useVbenModal } from '@vben/common-ui'
import dutyorgDetail from './dutyorgDetail.vue'
...
const batchDeleteOnes = async (row) => {
  try {
    ...
    await requestClient.post(import.meta.env.VITE_NSOSGZ + '/dutyOrg/remove', selectedRows.value)
