<template>
  <el-container class="h-full bg-white">
      ...
      >
        ...
        <el-table-column label="操作" align="center" width="150">
          <template #default="scope">
            <el-button link type="primary" size="small" @click="edit(scope.row)" style="margin-right: 20px">编辑</el-button>
    ...
    <Modal class="h-[620px] w-[850px]" title="值班模板维护" :footer="false" :closeOnClickModal="false" :draggable="true">
      <dutytemplate-detail :id="data.currentId" @closeDiaLog="closeDiaLog" @query="query" />
    </Modal>
  </el-container>
</template>
<script setup>
...
import { queryByPage } from './dutytemplateMethod.ts'
import { useVbenModal } from '@vben/common-ui'
import dutytemplateDetail from './dutytemplateDetail.vue'
...
const batchDeleteOnes = async (row) => {
  try {
    ...
    await requestClient.post(import.meta.env.VITE_NSOSGZ + '/dutyTemplate/remove', selectedRows.value)
