  ...
  <div style="width: 100%; height: 100%;">
    <div style="height: calc(100% - 50px)">
        <el-form label-width="auto" ref="formRef" :model="formData" :rules="formRules" :inline="true"
            ...
            <el-col :span="24">
              <el-form-item label="受令单位:" prop="slDept">
                <el-select v-model="formData.slDept" multiple placeholder="选择单位" collapse-tags collapse-tags-tooltip
                  ...
                  <el-option v-for="item in dropList.NSOS_ORG_NAME" :key="item.value" :label="item.label"
                    :value="item.value" />
                </el-select>
              </el-form-item>
            </el-col>
          ...
          <!-- <el-row><AttachList :parentId="formData.id"></AttachList></el-row> -->
        </el-form>
      </div>
...
onMounted(async () => {
  ...
  const dropType = ['NSOS_ORG_NAME','NSOS_CMD_FL']
