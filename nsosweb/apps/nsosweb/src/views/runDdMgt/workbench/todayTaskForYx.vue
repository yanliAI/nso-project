<template>
  <div class="main-bd">
    <el-card class="w-full h-[15%] flex condition-bg">
      <div class="flex text-sm items-center -mt-[8px]">
        <!-- <div class="flex cursor-pointer pl-2 w-[100px]">
          <List class="icon-cd" />
          <span class="pl-1">值班日志</span>
        </div>
        <div class="flex cursor-pointer pl-4 w-[80px]">
          <UserFilled class="icon-cd" />
          <span class="pl-1">交班</span>
        </div> -->
    ...
    <el-card class="w-full h-[85%] mt-[0.6%] stats-bg">
      ...
      <div class="dis-card content-center">
        <div class="w-full h-2/3 flex items-center">
          <div class="card-div">
            <el-card class="stats-card stats-card-tp card-yxgj">
              <div class="card-left">
          ...
          <div class="card-div">
            <el-card class="stats-card card-gz">
              <div class="card-left">
          ...
          <div class="card-div-long">
            <el-card class="stats-card card-zy">
              <div class="card-left">
          ...
          <div class="card-div">
            <el-card class="stats-card  card-zl">
              <div class="card-left">
          ...
          <div class="card-div">
            <el-card class="stats-card card-zb">
              <div class="card-left">
    ...
    <Modal class="w-[1200px] h-[630px]" :footer="false" :closeOnClickModal="false" :bordered="false" :draggable="true">
...
import { queryDlData, queryZlData } from './workbenchMethod.ts';
