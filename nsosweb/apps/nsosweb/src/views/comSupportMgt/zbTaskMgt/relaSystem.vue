...
const queryData = async () => {
  data.tableData = await requestClient.get(import.meta.env.VITE_NSOSGZ + '/secureOsInfo/querySecureOsByCode', { params: { guaranteeNo: formData.value.guaranteeNo, guaranteeOsType: '2' } })
...
const addRowClick = async () => {
  data.fmData = await requestClient.get(import.meta.env.VITE_NSOSGZ + '/secureOsInfo/initSecureOs', { params: { guaranteeNo: formData.value.guaranteeNo, guaranteeOsType: '2' } })
  modalApiA.open()
}
