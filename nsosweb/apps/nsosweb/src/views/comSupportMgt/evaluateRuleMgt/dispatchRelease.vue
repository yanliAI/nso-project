...
onMounted(async () => {
  ...
  await dropStore.initDrops(['NSOS_EVALUATE_TIMETYPE', 'NSOS_ORG_NAME_SJJC']);
  dropStore.get(dropList, ['NSOS_EVALUATE_TIMETYPE', 'NSOS_ORG_NAME_SJJC']);
});
...
const releaseApi = async () => {
  return requestClient.post(
    import.meta.env.VITE_NSOSZH + '/evaluateDispatchRule/release',
    formData,
