  ...
  <div style="width: 100%; height: 100%;">
    <div style="height: calc(100% - 1px)">
      <el-form label-width="auto" ref="formRef" :model="formData" :rules="formRules" :inline="true"
        ...
        <el-row >
          <el-col :span="12">
              <el-form-item label="名称:" prop="expertId" style="margin-bottom: 18px">
                <el-select v-model="formData.expertId" disabled>
          ...
          <el-col :span="12">
            <el-form-item label="姓名:" prop="expertName">
                  <el-input v-model="formData.expertName" disabled />
                </el-form-item>
            </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="关联系统:" prop="systemName">
              <el-input v-model="formData.systemName" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="手机:" prop="telPhone" style="margin-bottom: 18px">
              <el-input v-model="formData.telPhone"  disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
