...
export async function queryFile(queryInfo:any,pageInfo:any) {
  return requestClient.post(import.meta.env.VITE_NSOSZH + '/knowAttachment/queryAttachList',queryInfo,pageInfo);
}
